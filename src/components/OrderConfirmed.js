...
function OrderConfirmed({ cart, updateCart, updateIsOrderConfirmed }) {
    ...
    return (
        <div className="orderConfirmed">
                ...
                <ul>
                    {cart.map((item, index) => (
                        <li key={`${item.name}-${index}`}>
                            ...
                            <div>
                                <span className="final-cart-name">
                                    {item.name}
                                </span>
                                <br />
                                <span className="final-cart-quantity">
                                    {item.quantity}x
                                </span>
                                <span className="final-cart-price">
            ...
            <button onClick={resetCart} className="new-order">
                Start New Order
            </button>
        </div>
    )
